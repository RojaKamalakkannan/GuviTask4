...
title.innerHTML="CANDIDATE FORM"
document.head.append(title)

form=document.createElement("form")
form.setAttribute("id","form")
form.setAttribute("class","p-5 ")
form.innerHTML="<h1>FORM<h1>"
...
para.innerText="DOM MANIPULATION FORM"
div.append(para)
...
tablerowa.setAttribute("id","tr1")


tablerow2.appendChild(tablerowf)

let tablerowb = document.createElement("td")
tablerowb.setAttribute("id","tr2")
tablerow2.appendChild(tablerowl)

let tablerowc = document.createElement("td")
tablerowc.setAttribute("id","tr3")
tablerow2.appendChild(tablerowg)


let tablerowd = document.createElement("td")
tablerowd.setAttribute("id","tr4")
tablerow2.appendChild(tablerowa)


let tablerowe = document.createElement("td")
tablerowe.setAttribute("id","tr5")
tablerow2.appendChild(tablerowp)


let tablerowf = document.createElement("td")
tablerowf.setAttribute("id","tr6")
tablerow2.appendChild(tablerowfo)

let tablerowg = document.createElement("td")
tablerowg.setAttribute("id","tr7")
tablerow2.appendChild(tablerows)


let tablerowh = document.createElement("td")
tablerowh.setAttribute("id","tr8")
